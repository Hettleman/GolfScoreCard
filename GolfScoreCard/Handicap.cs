...
namespace GolfScoreCard
{
    ...
    {
    public static double HandicapCalc()
    {
        double handicap;
        int capacity = 20;
        List<double> scores = new List<double>(capacity) 
            {72, 73, 73, 74, 74, 74, 75, 76, 77, 79, 80, 81, 81, 81, 82, 83, 83, 84, 85, 86};
        List<double> slopes = new List<double>(capacity)
            { 113, 123, 119, 110, 134, 123, 112, 132, 133, 123, 142, 123, 130, 128, 120, 121, 114, 132, 154, 123 };
        List<double> ratings = new List<double>(capacity)
            { 72, 71, 72, 72, 71, 72, 73, 71, 71, 72, 70, 71, 72, 73, 72, 71, 71, 72, 72, 72 };
